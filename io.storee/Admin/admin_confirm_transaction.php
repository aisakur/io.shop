...
<head>
    ...
    <style>
        ...
        .container {
            ...
            max-width: 900px;
            margin: 0 auto;
            background-color: #fffaf0; /* Warna kontainer */
            border-radius: 10px;
            padding: 20px;
        ...
        .table {
            background-color: #ffe4c4; /* Warna bisque tabel */
        ...
        .table thead {
            background-color: #deb887; /* Warna header tabel */
        ...
        .btn-success {
            background-color: #6b4226; /* Tombol bisque gelap */
            border: none;
            border-radius: 5px;
            padding: 10px 20px;
            font-size: 1rem;
        ...
        .btn-success:hover {
            background-color: #8c5632; /* Warna hover */
            transform: scale(1.05);
            box-shadow: 0 6px 12px rgba(0, 0, 0, 0.3);
        }

        .btn-primary {
            background-color: #deb887; /* Tombol dashboard */
            border: none;
            color: white;
            border-radius: 5px;
            padding: 10px 20px;
