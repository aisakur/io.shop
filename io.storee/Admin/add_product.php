...
<head>
    ...
    <style>
        ...
        .navbar {
            background-color: #6b4226; /* Warna navbar bisque gelap */
            color: #ffffff;
        }

        .navbar .btn-primary {
            background-color: #deb887; /* Warna tombol di navbar */
            border: none;
            color: white;
        }
        ...
        .btn-success {
            background-color: #6b4226; /* Warna tombol Dashboard */
            border: none;
        }

        .btn-success:hover {
            background-color: #8c5632;
        }
        ...
        .card {
            ...
            background-color: #fffaf0; /* Warna latar kartu bisque terang */
        }

        .card-header {
            background-color: #deb887; /* Warna header kartu bisque gelap */
            color: #ffffff;
            text-align: center;
            font-weight: bold;
        }
        ...
        .btn-primary {
            background-color: #6b4226; /* Warna tombol Add Product */
            border: none;
            color: white;
        }
